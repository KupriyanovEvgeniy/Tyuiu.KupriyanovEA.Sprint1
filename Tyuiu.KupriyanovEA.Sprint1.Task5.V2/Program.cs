...
namespace Tyuiu.KupriyanovEA.Sprint1.Task5.V2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* переводит из градусов Фарингейта в градусы Цильсия                      *");
            Console.WriteLine("*                                                                         *");
            Console.WriteLine("***************************************************************************");
            ...
            Console.WriteLine("***************************************************************************");
            Console.WriteLine("Температура в Цельсиях = " + ds.FahrenheitToСelsius(temp));
            Console.ReadKey();
        }
    }
}
